...
if ($result) {
    ...
    echo "<h2>Usuários não encontrado.</h2>";
}
...
echo "<h1>Segurança nos parametros.</h1>";
$params = http_build_query(["name" => "Supriano"]);
